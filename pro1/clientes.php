...
<?php
session_start();
if(isset($_SESSION['corUsu']) and $_SESSION['tipUsu']=="Cliente")
    {
...
<body onLoad="BuscarActClientes(<?php echo($idUsuario); ?>);">
...
<div id="clientes">
	    <div id="titulo4"><img src="img/client.png" width="300px" height="90px"></div>	
    <div><!--contenedor menu proyectos-->
    	<div id="conPro3"> <img src="img/busCli.png" width="200px" height="50px"> </div>  
        
	    <div id="zzz5">
	    		<div ><div id="resultadosUsu" class="resultadosUsu" ></div>
		</div>	                    
	</div><!--div zzz5-->        
...
<link type="text/css" href="hojas/estiloAdmin.css" rel="stylesheet" />
        ...
        <form action="" method="get" name="ingresar" id="formCliePerfil">
